...
-- Indexes
CREATE INDEX "appointment_artist_profile_id_idx" ON "appointment" USING btree ("artistProfileId");
CREATE INDEX "appointment_customer_id_idx" ON "appointment" USING btree ("customerId");
CREATE INDEX "appointment_scheduled_at_idx" ON "appointment" USING btree ("artistProfileId", "scheduledAt");

--
-- Class AppointmentMaterial as table appointment_material
--
...
-- Indexes
CREATE INDEX "appointment_material_appointment_id_idx" ON "appointment_material" USING btree ("appointmentId");
CREATE INDEX "appointment_material_material_id_idx" ON "appointment_material" USING btree ("materialId");
...
CREATE TABLE "artist_profile" (
    ...
    "expirationAlertDays" bigint NOT NULL DEFAULT 30,
...
-- Indexes
CREATE INDEX "artist_profile_auth_user_id_idx" ON "artist_profile" USING btree ("authUserId");
CREATE UNIQUE INDEX "artist_profile_handle_unique" ON "artist_profile" USING btree ("handle");
...
--
-- Class RecallContact as table recall_contact
--
...
-- Indexes
CREATE UNIQUE INDEX "recall_contact_unique_idx" ON "recall_contact" USING btree ("artistProfileId", "customerId", "batchNumber");

--
-- Class SecureLink as table secure_link
--
...
--
-- Class SessionRecord as table session_record
--
CREATE TABLE "session_record" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid_v7(),
    "appointmentId" uuid NOT NULL,
    "hash" text NOT NULL,
    "sealedAt" timestamp without time zone NOT NULL,
...
--
-- Class StoredFile as table stored_file
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('octattoo', '20260430180249425', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260430180249425', "timestamp" = now();

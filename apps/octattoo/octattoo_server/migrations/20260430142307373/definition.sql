...
-- Indexes
CREATE UNIQUE INDEX "session_record_appointment_id_idx" ON "session_record" USING btree ("appointmentId");
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('octattoo', '20260430142307373', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260430142307373', "timestamp" = now();
